			...
			<li class="relative px-6 py-3">
				<a class="inline-flex items-center w-full text-sm font-semibold 
					...
					<svg class="w-5 h-5"
						...
						viewBox="0 0 24 24"
						stroke="currentColor">
					<path d="M15 15l-2 5L9 9l11 4-5 2zm0 0l5 5M7.188 2.239l.777 2.897M5.136"></path>
					<path d="7.965l-2.898-.777M13.95 4.05l-2.122 2.122m-5.657 5.656l-2.12 2.122"></path>
					</svg>
