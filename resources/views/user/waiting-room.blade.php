    ...
    <div class="font-poppins mt-10">
        <div class="flex flex-col mx-auto justify-center items-center z-10 pt-3 max-w-md">
            <div class="sm:max-w-sm z-10 max-w-xs">
                ...
                {{-- generate code --}}
                    <h1 class="text-2xl text-center py-4">12322</h1>
            ...
            {{-- button --}}
            <a herf="#" class="bg-green-nav my-8 rounded-md py-1 px-8 text-white font-bold text-2xl hover:bg-green-darkBg z-10">JOIN</a>
        </div>
    </div>
</x-main>