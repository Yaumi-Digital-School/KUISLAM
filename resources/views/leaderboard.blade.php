<x-main-layout titlePage="Laravel">
    ...
    {{-- Rank --}}
    <div class="grid grid-cols-4 sm:gap-4 gap-y-4 gap-x-2 sm:grid-flow-col grid-flow-row z-10 relative sm:px-12 px-4 rounded-full items-center">
        {{-- 1st --}}
        {{-- Medal --}}
        ...
        {{-- 4th --}}
        {{-- Medal --}}
        <div class="sm:flex sm:justify-end hidden ">
            <img class="z-20 relative w-10 sm:w-20 h-10 sm:h-20" src="{{asset('images/4th_medal.svg')}}"> 
        </div>
        <div class="px-12 sm:px-0 row-start-4 sm:col-start-2 col-start-1 sm:col-end-4 col-end-4">
            <div class="row-start-4 sm:col-start-2 col-start-1 sm:col-end-4 col-end-4 bg-gray-100 flex justify-between sm:w-full w-60 sm:h-24 h-12 rounded-lg z-10 relative p-4 items-center">
                {{-- User Info --}}
                <div class="flex items-center">
                    <div class="flex items-center sm:h-16 h-8 sm:w-16 w-8 mr-2">
                        <img src="{{asset('images/default_profpic.png')}}" class="rounded-full border-green-nav border-2">
