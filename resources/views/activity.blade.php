       ...
       <div class="max-w-screen-xl 3xl:max-w-screen-2xl mx-auto h-screen ">
           <div class="px-4 xl:px-0 pb-20 relative z-10">
            ...
            <div class="flex items-center space-x-5 text-md lg:text-lg font-medium text-gray-link mb-4 lg:mb-8">
                <a href="{{ route('test.activity') }}" class="@if (request()->routeIs("test.activity")) text-green-nav border-b-4 border-green-nav @endif" >Selesai</a>
                <a href="{{ route('test.activity.made') }}" class="@if (request()->routeIs("test.activity.made")) text-green-nav border-b-4 border-green-nav @endif">Dibuat</a>
            </div>
            {{-- grid content  --}}
                            ...
                            <div class="flex flex-col justify-between h-2/5">
                                <div class="flex flex-col space-y-1 p-1">
                                    <a href="" class="font-bold">
                                        <h3 class="text-sm text-black-cardText">Ini Title Quiz</h3>
                                        <span class="text-sm text-gray-cardText">Ini Description Quiz</span>
                                    </a>
                                </div>
                                @auth
            ...
            @elseif (request()->routeIs("test.activity.made"))
                <div class="">
