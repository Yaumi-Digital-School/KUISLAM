<x-main-layout titlePage="Laravel" >
    ...
    <div class="font-poppins mt-6 mb-10 ">
        <div class="flex flex-col mx-auto justify-center items-center  pt-3 max-w-md">
            ...
            {{-- button --}}
            <a href="{{ route('room.make', $quiz->id) }}" class="bg-white my-8 sm:w-64 py-2 rounded-md text-green-nav font-bold text-2xl cursor-pointer z-10 w-3/4 text-center shadow-profile">BUAT RUANGAN</a>
        </div>
    </div>
    @section('script')
        <script>
